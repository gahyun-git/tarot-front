...
const dict: Record<Locale, Messages> = {
  ko: {
    ...
    "sort.nameAsc": "이름A-Z",
    "sort.nameDesc": "이름Z-A",
    "sort.majorFirst": "메이저→마이너",
    "sort.minorFirst": "마이너→메이저",
    "hero.heading1": "오늘의",
    "hero.heading2": "타로카드",
    ...
    "nav.contact": "문의",
    "nav.cards": "카드목록",
    "about.intro": "go4it.site 는 운세/점 서비스 허브입니다. 타로를 시작으로 다양한 점술을 쉽고 재미있게 제공합니다.",
    "about.disclaimer": "본 서비스의 해석은 오락/참고 목적이며, 의료·법률·금융 등 전문적 조언이 아닙니다.",
    "privacy.intro": "본 서비스는 서비스 제공을 위해 최소한의 정보를 사용합니다.",
    "privacy.list.local": "로컬 저장소: 언어, 리딩 히스토리",
    "privacy.list.logs": "서버 로그: 오류/성능 진단용",
    "privacy.list.third": "제3자: Google AdSense(광고), Analytics(선택)",
    "privacy.contact": "문의: ",
    "terms.intro": "본 서비스를 이용함으로써, 귀하는 서비스가 오락/참고 목적임을 이해하고 동의합니다. 서비스 제공자는 서비스 사용으로 인한 직접적/간접적 손해에 대해 책임을 지지 않습니다.",
    "contact.email": "문의 이메일:",
    "contact.note": "광고/제휴/피드백 환영합니다.",
    "label.keywords": "키워드",
  ...
  en: {
    "label.sort": "Sort",
    "sort.numberAsc": "Number↑",
    "sort.numberDesc": "Number↓",
    "sort.nameAsc": "Name A-Z",
    "sort.nameDesc": "Name Z-A",
    "sort.majorFirst": "Major→Minor",
    "sort.minorFirst": "Minor→Major",
    ...
    "btn.guide": "Guide",
    "btn.use": "Start",
    "spread.daily": "Daily One Card",
    "spread.eight": "Problem Reading",
    "form.selectedSpread": "Selected Spread",
    "kw.new": "New beginnings",
    "kw.freedom": "Freedom",
    ...
    "nav.contact": "Contact",
    "nav.cards": "Cards",
    "about.intro": "go4it.site is a hub for fortune/tarot services. We aim to make divination easy and fun.",
    "about.disclaimer": "Readings are for entertainment/information only and not professional advice (medical/legal/financial).",
    "privacy.intro": "We use the minimum data necessary to provide the service.",
    "privacy.list.local": "Local storage: language, reading history",
    "privacy.list.logs": "Server logs: for error/performance diagnostics",
    "privacy.list.third": "Third parties: Google AdSense (ads), Analytics (optional)",
    "privacy.contact": "Contact: ",
    "terms.intro": "By using this service you agree it's for entertainment/information only. We are not liable for any damages.",
    "contact.email": "Contact email:",
    "contact.note": "Ads/partnership/feedback welcome.",
    "label.keywords": "Keywords",
    "label.solutionCard": "Solution card",
    "tab.summary": "Summary",
    "tab.keywords": "Keywords",
    "tab.upright": "Upright",
    "tab.reversed": "Reversed",
    "modal.close": "Close",
    "position.1": "Issue",
  ...
  ja: {
    ...
    "sort.nameAsc": "名前A-Z",
    "sort.nameDesc": "名前Z-A",
    "sort.majorFirst": "メジャー→マイナー",
    "sort.minorFirst": "マイナー→メジャー",
    "hero.heading1": "あなたの",
    ...
    "btn.use": "はじめる",
    "spread.daily": "今日のカード",
    "spread.eight": "悩みリーディング",
    "form.selectedSpread": "選択したスプレッド",
    "kw.new": "新たな始まり",
    "kw.freedom": "自由",
    "nav.question": "質問",
    "nav.summary": "要約",
    ...
    "nav.contact": "お問い合わせ",
    "nav.cards": "カード一覧",
    "about.intro": "go4it.site は占い/タロットのハブです。楽しく気軽に利用できるサービスを目指します。",
    "about.disclaimer": "本サービスの解釈は娯楽/参考目的であり、医療・法律・金融等の専門的助言ではありません。",
    "privacy.intro": "本サービスは提供のために最小限のデータのみを利用します。",
    "privacy.list.local": "ローカル保存: 言語、リーディング履歴",
    "privacy.list.logs": "サーバーログ: エラー/性能診断のため",
    "privacy.list.third": "第三者: Google AdSense(広告)、Analytics(任意)",
    "privacy.contact": "お問い合わせ: ",
    "terms.intro": "本サービスは娯楽/参考目的です。利用による損害について運営者は責任を負いません。",
    "contact.email": "お問い合わせメール:",
    "contact.note": "広告/提携/フィードバック歓迎。",
  ...
  zh: {
    ...
    "sort.nameAsc": "名称A-Z",
    "sort.nameDesc": "名称Z-A",
    "sort.majorFirst": "大阿尔克那→小阿尔克那",
    "sort.minorFirst": "小阿尔克那→大阿尔克那",
    "hero.heading1": "让你的",
    "hero.heading2": "解读！",
    ...
    "nav.contact": "联系",
    "nav.cards": "卡牌列表",
    "about.intro": "go4it.site 是占卜/塔罗服务平台，致力于让占卜更简单有趣。",
    "about.disclaimer": "本服务的解读仅供娱乐/参考，不构成医疗、法律或金融建议。",
    "privacy.intro": "我们仅使用提供服务所必需的最少数据。",
    "privacy.list.local": "本地存储：语言、解读历史",
    "privacy.list.logs": "服务器日志：用于错误/性能诊断",
    "privacy.list.third": "第三方：Google AdSense（广告）、Analytics（可选）",
    "privacy.contact": "联系：",
    "terms.intro": "使用本服务即表示您理解并同意其仅供娱乐/参考，我们不对任何损失承担责任。",
    "contact.email": "联系邮箱：",
    "contact.note": "欢迎广告/合作/反馈。",
    "label.keywords": "关键词",
